...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if (Request::is('eselon-empat') == 1 || Request::is('eselon-empat/kirim/*') == 1) active @endif">
                <a class="nav-link" href="{{ url('eselon-empat') }}">
                    <i class="fas fa-fw fa-envelope"></i>
                    <span>Surat Masuk</span></a>
            </li>

            <!-- Nav Item - Surat Terkirim -->
            <li class="nav-item @if (Request::is('eselon-empat/terkirim') == 1) active @endif">
                <a class="nav-link" href="{{ url('eselon-empat/terkirim') }}">
                    <i class="fas fa-fw fa-paper-plane"></i>
                    <span>Surat Terkirim</span></a>
            </li>
