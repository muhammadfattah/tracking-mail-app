...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if (Request::is('eselon-tiga') == 1 || Request::is('eselon-tiga/kirim/*') == 1) active @endif">
                <a class="nav-link" href="{{ url('eselon-tiga') }}">
                    <i class="fas fa-fw fa-envelope"></i>
                    <span>Surat Masuk</span></a>
            </li>

            <!-- Nav Item - Surat Terkirim -->
            <li class="nav-item @if (Request::is('eselon-tiga/terkirim') == 1) active @endif">
                <a class="nav-link" href="{{ url('eselon-tiga/terkirim') }}">
