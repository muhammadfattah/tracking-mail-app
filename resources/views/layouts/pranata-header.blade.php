...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if (Request::is('pranata') == 1 || Request::is('pranata/kirim/*') == 1) active @endif">
                <a class="nav-link" href="{{ url('pranata') }}">
                    <i class="fas fa-fw fa-envelope"></i>
                    <span>Surat Masuk</span></a>
            </li>

            <!-- Nav Item - Surat Terkirim -->
            <li class="nav-item @if (Request::is('pranata/terkirim') == 1) active @endif">
                <a class="nav-link" href="{{ url('pranata/terkirim') }}">
