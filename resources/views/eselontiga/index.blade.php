        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-sm text-center" id="dataTable">
                    ...
                    <tbody class="tbody-table table-surat-masuk" data-url="{{ url('eselon-tiga/datatable') }}">
                        @if (count($mails) == 0)
                            <tr>
                                ...
                                <tr class="text-dark">
                                    ...
                                    <td class="text-nowrap align-middle">
                                        <button class="btn btn-primary btn-sm tombol-detail penerima"
                                            data-url="{{ url('eselon-tiga', [$mail->id]) }}"
                                            data-from_id="{{ $mail->from_id }}" data-is_read="{{ $mail->is_read }}"><i
                                                class="  fa fa-fw fa-info-circle"></i>
                                            Detail</button>
                                        <form action="{{ url('eselon-tiga', [$mail->id, 'penerima']) }}" method="POST"
