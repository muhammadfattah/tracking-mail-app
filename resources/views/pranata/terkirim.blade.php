        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-sm text-center table-hover" id="dataTable">
                    ...
                    <tbody class="tbody-table surat-terkirim" data-url="{{ url('pranata/datatable-terkirim') }}">
                        @if (count($mails) == 0)
                            <tr>
                                ...
                                <tr class="text-dark">
                                    ...
                                    <td class="text-nowrap align-middle">
                                        <button class="btn btn-primary btn-sm tombol-detail"
                                            data-url="{{ url('pranata', [$mail->id]) }}"><i
                                                class="fa fa-fw fa-info-circle"></i>
                                            Detail</button>
                                        <form action="{{ url('pranata', [$mail->id, 'pengirim']) }}" method="POST"
