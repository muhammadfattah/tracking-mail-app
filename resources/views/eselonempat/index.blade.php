        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-sm text-center" id="dataTable">
                    ...
                    <tbody class="tbody-table table-surat-masuk" data-url="{{ url('eselon-empat/datatable') }}">
                        @if (count($mails) == 0)
                            <tr>
