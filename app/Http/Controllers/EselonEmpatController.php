...
class EselonEmpatController extends Controller
{
    /**
    ...
    {
        $mail = new Mail();
        return view('eselonempat.terkirim', [
    ...
    public function kirim($id)
    {
        ...
        return view('eselonempat.create', [
            'title'   => 'Kirim Surat',
            'pranata' => User::all()->where('role', 'Pranata'),
            'mail'    => $mailData
        ]);
    }
    ...
    public function store(Request $request)
    {
        if (!$request->validate([
            ...
            return redirect()->to(url('eselon-empat/terkirim'))->with('message', [
                'icon'  => 'success',
                'title' => 'Surat',
