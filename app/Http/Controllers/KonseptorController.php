...
class KonseptorController extends Controller
{
    ...
    {
        $mail = new Mail();
        return view('konseptor.terkirim', [
    ...
    public function kirim($id)
    {
        ...
        return view('konseptor.create', [
            'title'   => 'Kirim Surat',
            'eselon3' => User::all()->where('role', 'Eselon 3'),
            'mail'    => $mailData
        ]);
    }
    ...
    public function store(Request $request)
    {
        if (!$request->validate([
            ...
            return redirect()->to(url('konseptor/terkirim'))->with('message', [
                'icon'  => 'success',
                'title' => 'Surat',
